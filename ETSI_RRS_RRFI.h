...
public:
    ...
    std::vector<std::string> get_rxAntennaPorts();  // My Work
        //Power Control Services
    ...
    bool tx_from_buff(std::vector<std::complex<int16_t>>, size_t);
    ...
    std::vector<std::complex<int16_t>> rx_to_buff(size_t, float, int);
