...
std::vector<std::string> ETSI_RRS_AntennaManagementServices::get_rxAntennaPorts(int channel) // My Work
{
    usrpDevice->usrp->get_rx_antennas(size_t(channel));
    /*if (this->rxAntennaPorts == usrpDevice->usrp->get_rx_antennas(size_t(channel))) {
        return rxAntennaPorts;
    } else {
        cout << "Error 2" << endl;
    }*/
